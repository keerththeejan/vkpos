...
<section class="content js-shell js-form-shell">
    <div class="js-header" role="banner">
        <div class="js-header-left">
            <h1>@lang('repair::lang.job_sheet') <small style="font-weight:600;color:var(--js-muted);">@lang('repair::lang.create')</small></h1>
            <p class="js-subtitle">Customer intake · device · diagnosis · checklist · estimate</p>
            <div class="js-breadcrumb" aria-label="Breadcrumb">
                <span>@lang('repair::lang.repair')</span>
                <span>/</span>
                <span>@lang('repair::lang.job_sheets')</span>
                <span>/</span>
                <span>@lang('repair::lang.create')</span>
            </div>
        </div>
        <div class="js-header-actions">
            <button type="button" class="js-btn js-btn-ghost" id="js_dark_mode_toggle" title="Dark Mode" aria-label="Toggle dark mode"><i class="fas fa-moon"></i></button>
            <a class="js-btn" href="{{ action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'index']) }}"><i class="fas fa-arrow-left"></i> Back</a>
            <button type="button" class="js-btn js-btn-success" id="js_header_save"><i class="fas fa-save"></i> @lang('messages.save')</button>
            <button type="button" class="js-btn js-btn-primary" id="js_header_save_parts"><i class="fas fa-plus"></i> @lang('repair::lang.save_and_add_parts')</button>
        </div>
    </div>
    ...
    {!! Form::open(['action' => '\Modules\Repair\Http\Controllers\JobSheetController@store', 'id' => 'job_sheet_form', 'method' => 'post', 'files' => true]) !!}
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="js-section-label"><i class="fas fa-user"></i> Customer &amp; Service</div>
                <div class="row">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="js-section-label"><i class="fas fa-mobile-alt"></i> Device Information</div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="js-section-label"><i class="fas fa-stethoscope"></i> Diagnosis · Charges · Attachments</div>
                <div class="row">
