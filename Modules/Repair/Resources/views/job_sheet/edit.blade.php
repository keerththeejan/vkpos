...
<section class="content js-shell js-form-shell">
    <div class="js-header" role="banner">
        <div class="js-header-left">
            <h1>@lang('repair::lang.job_sheet') <code style="font-size:16px;">{{$job_sheet->job_sheet_no}}</code></h1>
            <p class="js-subtitle">Update customer, device, diagnosis, checklist, and estimate</p>
            <div class="js-breadcrumb" aria-label="Breadcrumb">
                <span>@lang('repair::lang.repair')</span>
                <span>/</span>
                <span>@lang('repair::lang.job_sheets')</span>
                <span>/</span>
                <span>{{$job_sheet->job_sheet_no}}</span>
            </div>
        </div>
