{!! Form::open(['action' => '\Modules\Repair\Http\Controllers\RepairSettingsController@updateJobsheetSettings', 'method' => 'post', 'id' => 'jobsheet_settings_form']) !!}
@php
...
@endphp
<div class="rs-section-block" data-rs-search="job sheet pdf customer details client">
<div class="row">
    <div class="col-sm-12">
        <div class="rs-section-title"><i class="fas fa-file-pdf"></i> @lang('repair::lang.job_sheet_pdf')</div>
    </div>
...
<div class="rs-section-block" data-rs-search="label width height barcode technician device">
<div class="row">
    <div class="col-sm-12">
        <div class="rs-section-title"><i class="fas fa-tags"></i> @lang('repair::lang.job_sheet_label')</div>
    </div>
