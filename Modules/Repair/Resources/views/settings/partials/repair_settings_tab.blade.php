{!! Form::open(['action' => '\Modules\Repair\Http\Controllers\RepairSettingsController@store', 'method' => 'post', 'id' => 'repair_settings_form']) !!}
<div class="rs-section-block" data-rs-search="default status job sheet prefix checklist">
<div class="rs-section-title"><i class="fas fa-sliders-h"></i> General · Job Sheet Defaults</div>
<div class="row">
    <!-- <div class="col-sm-4">
...
<div class="rs-section-block" data-rs-search="configuration defects condition problem product">
<div class="rs-section-title"><i class="fas fa-list-ul"></i> Intake Lists</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
...
<div class="rs-section-block" data-rs-search="terms conditions tc">
<div class="rs-section-title"><i class="fas fa-file-contract"></i> Terms &amp; Conditions</div>
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
...
<hr>
<div class="rs-section-block" data-rs-search="custom field label">
<div class="rs-section-title"><i class="fas fa-tags"></i> Custom Fields</div>
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
...
<div class="row">
    <div class="col-md-12">
        ...
        {{Form::submit('update', ['class'=>"btn btn-danger rs-submit-btn"])}}
        </div>
    </div>
</div>
{!! Form::close() !!}