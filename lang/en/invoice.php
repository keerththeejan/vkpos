...
return [
    ...
    */
    ...
    'standard' => 'Standard',
    'next_number' => 'Next No',
    'invoice_count_locked' => 'This counter is not editable. Future invoice numbers continue from the current count.',
    'cannot_delete_default' => 'The default invoice scheme cannot be deleted.',
    'cannot_delete_in_use' => 'This invoice scheme is assigned to a business location and cannot be deleted.',
    'reset_filters' => 'Reset',
    'layout_preview_no_sale' => 'No sale is available to preview. Create an invoice first, then preview will use that receipt.',
    'layout_preview' => 'Preview',
    'layout_saving' => 'Saving...',
    'layout_back_to_list' => 'Back to invoice settings',
    'layout_paper' => 'Paper / design',
    'layout_header' => 'Header & logo',
    'layout_invoice_details' => 'Invoice details',
    'layout_products' => 'Product table',
    'layout_totals' => 'Totals & payments',
    'layout_footer_section' => 'Footer',
    'layout_unsaved_changes' => 'You have unsaved changes.',
];
