...
return [
    ...
    'ledger_help' => 'Review account activity, debit, credit and running balance for the selected period.',
    'ledger_empty_title' => 'Select an account',
    'ledger_empty_help' => 'Choose an account to view its financial statement.',
    'ledger_none_title' => 'No transactions found',
    'ledger_none_help' => 'No ledger transactions were found for the selected period and filters.',
    'ledger_date_from' => 'Date from',
    'ledger_date_to' => 'Date to',
    'ledger_custom' => 'Custom',
    'ledger_view_row' => 'View',
    'ledger_print_voucher' => 'Print voucher',
    'ledger_period' => 'Period',
    'ledger_location' => 'Location',
    'ledger_view' => 'View Ledger',
    'ledger_total_accounts' => 'Total accounts',
    'ledger_tx_today' => 'Transactions today',
    'ledger_debit_today' => 'Debit today',
    'ledger_credit_today' => 'Credit today',
    'ledger_statement' => 'Detailed account transaction statement',
    'ledger_filters' => 'Statement filters',
    'ledger_account_statement' => 'Account statement',
    'ledger_change_filters' => 'Change filters',
    'ledger_posted' => 'Posted',
    'ledger_draft' => 'Draft',
    'ledger_cancelled' => 'Cancelled',
    'ledger_no_payment_accounts' => 'Cash and bank statements appear here after a payment account is created. Customer and supplier statements are available now.',
    'ledger_search_placeholder' => 'Voucher, reference, description, customer or supplier',
    'ledger_search_account' => 'Search account / customer / supplier / cash / bank',
    'ledger_per_page' => 'Rows',
    'ledger_include_cancelled' => 'Include cancelled',
    'ledger_this_week' => 'This week',
    'ledger_this_month' => 'This month',
    'ledger_previous_month' => 'Previous month',
    'ledger_this_fy' => 'This financial year',
    'ledger_select_account' => 'Select an account to view its statement.',
    'ledger_no_transactions' => 'No transactions found for the selected account and date range.',
    'ledger_view_voucher' => 'View voucher',
    'ledger_showing' => 'Showing :from–:to of :total transactions',
    'ledger_normal' => 'Normal balance',
    'ledger_normal_account' => 'Credit increases this payment account',
    'ledger_normal_customer' => 'Debit (receivable)',
    'ledger_normal_supplier' => 'Credit (payable)',
    'ledger_closing' => 'Closing balance',
    'ledger_filtered_note' => 'Totals follow the voucher and search filters. The opening balance is the full balance before the start date.',
