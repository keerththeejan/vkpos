<div class="modal-dialog modal-lg bloc-location-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">Location information</div>
                </div>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">Contact information</div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">Invoice configuration</div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">Pricing configuration</div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                @endphp
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">Additional fields</div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                ...
                <div class="clearfix"></div>
                <div class="col-sm-12">
                    <div class="bloc-form-section-title">@lang('lang_v1.payment_options') @show_tooltip(__('lang_v1.payment_option_help'))</div>
                    <div class="form-group">
                        <table class="table table-condensed table-striped bloc-payment-table">
                            <thead>
                                <tr>
