...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="clearfix"></div>
        <div class="col-sm-8">
            <div class="form-group pt-description-card">
                {!! Form::label('product_description', __('lang_v1.product_description') . ':') !!}
                {!! Form::textarea('product_description', !empty($duplicate_product->product_description) ? $duplicate_product->product_description : null, ['class' => 'form-control', 'placeholder' => 'Enter a detailed product description...']); !!}
                <div class="pt-description-meta">
                    <span>Supports rich product details for invoices & catalogs</span>
                    <span id="pt_description_counter">0 characters</span>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            @include('product.partials.enable_sr_no_panel', [
                'enable_sr_no_checked' => !(empty($duplicate_product)) ? $duplicate_product->enable_sr_no : false,
            ])
            @include('product.partials.serial_number_management', [
...
@section('css')
<link rel="stylesheet" href="{{ asset('css/product-tracking-premium.css?v=' . $asset_v) }}">
@endsection

@section('javascript')

<script src="{{ asset('js/product.js?v=' . $asset_v) }}"></script>
<script src="{{ asset('js/product-tracking-ui.js?v=' . $asset_v) }}"></script>
<script src="{{ asset('js/product-serial-management.js?v=' . $asset_v) }}"></script>
