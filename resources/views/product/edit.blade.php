            ...
            <div class="col-sm-8">
              <div class="form-group pt-description-card">
                {!! Form::label('product_description', __('lang_v1.product_description') . ':') !!}
                  {!! Form::textarea('product_description', $product->product_description, ['class' => 'form-control', 'placeholder' => 'Enter a detailed product description...']); !!}
        ...
        @if(session('business.enable_product_expiry'))
          ...
          <div class="col-sm-12">
            @include('product.partials.enable_sr_no_panel', [
                'enable_sr_no_checked' => $product->enable_sr_no,
            ])
            @include('product.partials.serial_number_management', [
                'serial_numbers' => $product->serial_numbers ?? collect(),
            ])
          </div>
