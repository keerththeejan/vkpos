...
@section('css')
<link rel="stylesheet" href="{{ asset('css/purchases-create-premium.css?v=' . $asset_v) }}">
<link rel="stylesheet" href="{{ asset('css/purchase-imei-receiving.css?v=' . $asset_v) }}">
@endsection
...
<section class="content pc-shell">
	{{-- Sticky Header --}}
	<div class="pc-header" role="banner">
		<div class="pc-header-left">
			<h1>@lang('purchase.add_purchase')
			...
			<p class="pc-subtitle">Supplier · products · tax · shipping · payment</p>
			<div class="pc-breadcrumb" aria-label="Breadcrumb">
				<span>Home</span>
				<span>/</span>
		...
		<div class="pc-header-actions">
			<button type="button" class="pc-btn pc-btn-ghost" id="pc_dark_mode_toggle" title="Dark Mode" aria-label="Toggle dark mode"><i class="fas fa-moon"></i></button>
			<button type="button" class="pc-btn" id="pc_refresh_btn" title="Refresh"><i class="fas fa-sync-alt"></i> Refresh</button>
			<a class="pc-btn" href="{{ action([\App\Http\Controllers\PurchaseController::class, 'index']) }}"><i class="fas fa-times"></i> Cancel</a>
			<button type="button" class="pc-btn pc-btn-primary" id="pc_header_save"><i class="fas fa-save"></i> @lang('messages.save')</button>
		</div>
		<div class="pc-header-meta" aria-label="Purchase context">
			<div class="pc-meta-item"><span>Purchase #</span><strong id="pc_meta_ref">Auto</strong></div>
			<div class="pc-meta-item"><span>Location</span><strong id="pc_meta_location">—</strong></div>
			<div class="pc-meta-item"><span>Supplier</span><strong id="pc_meta_supplier">—</strong></div>
			<div class="pc-meta-item"><span>Date</span><strong id="pc_meta_date">—</strong></div>
			<div class="pc-meta-item"><span>Status</span><strong id="pc_meta_status">—</strong></div>
		</div>
	</div>

	<div class="pc-future-strip" aria-label="Coming soon">
		<span class="pc-chip"><i class="fas fa-mobile-alt"></i> IMEI Receive</span>
		<span class="pc-chip"><i class="fas fa-qrcode"></i> QR Scanner</span>
		<span class="pc-chip"><i class="fas fa-camera"></i> Camera Scan</span>
		<span class="pc-chip"><i class="fas fa-bluetooth"></i> Bluetooth</span>
		<span class="pc-chip"><i class="fas fa-warehouse"></i> Multi-WH</span>
		<span class="pc-chip muted">IMEI receiving active for tracked products</span>
	</div>
	...
	@component('components.widget', ['class' => 'box-primary pc-card', 'title' => ''])
		<div class="pc-section-title"><i class="fas fa-truck"></i> Supplier &amp; Purchase Information</div>
		<div class="row">
	...
	@component('components.widget', ['class' => 'box-primary pc-card'])
		<div class="pc-section-title"><i class="fas fa-boxes"></i> Product Entry Grid</div>
		<div class="row">
	...
	{{-- IMEI panels render inline under each enable_sr_no product row --}}
	<div class="pc-card pc-imei-placeholder" id="pc_imei_placeholder">
		<div class="pc-section-title"><i class="fas fa-barcode"></i> IMEI / Serial Number Receiving</div>
		<p class="pc-muted">When a product has <strong>Enable Product description, IMEI or Serial Number</strong>, the receiving panel appears under that product. Enter exactly one IMEI per purchased quantity before saving.</p>
		<div class="pc-imei-counters">
			<div><span class="k">Required</span><strong id="pc_imei_required">0</strong></div>
			<div><span class="k">Entered</span><strong id="pc_imei_entered">0</strong></div>
			<div><span class="k">Remaining</span><strong id="pc_imei_remaining">0</strong></div>
		</div>
	</div>

	@component('components.widget', ['class' => 'box-primary pc-card'])
		<div class="pc-section-title"><i class="fas fa-percent"></i> Discount · Tax · Notes</div>
		<div class="row">
			<div class="col-sm-12">
			<table class="table">
				<tr>
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary pc-card'])
	<div class="pc-section-title"><i class="fas fa-shipping-fast"></i> Shipping &amp; Expenses</div>
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary pc-card', 'title' => __('purchase.add_payment')])
		<div class="pc-section-title"><i class="fas fa-credit-card"></i> @lang('purchase.add_payment')</div>
		<div class="box-body payment_row">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<button type="button" id="submit_purchase_form" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white pc-submit-btn">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	@endcomponent
...
{!! Form::close() !!}
	...
	<aside class="pc-summary" aria-label="Purchase summary">
		<div class="pc-summary-card">
			<h3>Purchase Summary</h3>
			<div class="pc-summary-rows">
				<div><span>Items / Qty</span><strong><span id="pc_sum_qty">0</span></strong></div>
				<div><span>@lang('purchase.net_total_amount')</span><strong><span id="pc_sum_subtotal">0</span></strong></div>
				<div><span>@lang('purchase.discount')</span><strong><span id="pc_sum_discount">0</span></strong></div>
				<div><span>@lang('purchase.purchase_tax')</span><strong><span id="pc_sum_tax">0</span></strong></div>
				<div class="pc-summary-total"><span>@lang('purchase.purchase_total')</span><strong><span id="pc_sum_grand">0</span></strong></div>
				<div><span>@lang('purchase.payment_due')</span><strong><span id="pc_sum_due">0</span></strong></div>
			</div>
			<button type="button" class="pc-btn pc-btn-primary pc-btn-block" id="pc_side_save"><i class="fas fa-save"></i> @lang('messages.save')</button>
			<a class="pc-btn pc-btn-block" href="{{ action([\App\Http\Controllers\PurchaseController::class, 'index']) }}"><i class="fas fa-arrow-left"></i> Back to list</a>
		</div>
	</aside>
	</div>{{-- /.pc-layout --}}
</section>
...
@section('javascript')
	...
	<script src="{{ asset('js/purchase-imei-receiving.js?v=' . $asset_v) }}"></script>
	<script src="{{ asset('js/purchases-create-premium-ui.js?v=' . $asset_v) }}"></script>
