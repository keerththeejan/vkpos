@foreach( $variations as $variation)
    <tr class="purchase_product_row" data-enable_sr_no="{{ (int) $product->enable_sr_no }}" data-row_index="{{ $row_count }}" data-product_id="{{ $product->id }}" data-variation_id="{{ $variation->id }}" @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif @if(!empty($purchase_requisition_line)) data-purchase_requisition_id="{{$purchase_requisition_line->transaction_id}}" @endif>
        ...
        <td>
            ...
            <div class="pir-panel" data-row-index="{{ $row_count }}" style="margin-top:10px;text-align:left;">
                <div class="pir-head">
        ...
        <td>
            ...
            <input type="hidden" class="enable_sr_no" value="{{ (int) $product->enable_sr_no }}">
            <input type="hidden" class="purchase_row_product_name" value="{{ $product->name }}">
            <input type="hidden" class="purchase_row_index" value="{{ $row_count }}">
