...
@section('css')
<link rel="stylesheet" href="{{ asset('css/tax-report-premium.css?v=' . $asset_v) }}">
@endsection

@section('content')

<section class="content tx-shell">
    {{-- Sticky Header --}}
    <div class="tx-header no-print" role="banner">
        <div class="tx-header-left">
            <h1>@lang( 'report.tax_report' )</h1>
            <p class="tx-subtitle">@lang( 'report.tax_report_msg' )</p>
            <div class="tx-breadcrumb" aria-label="Breadcrumb">
                <span>Home</span>
                <span>/</span>
                <span>Reports</span>
                <span>/</span>
        ...
        <div class="tx-header-actions">
            <button type="button" class="tx-btn tx-btn-ghost" id="tx_dark_mode_toggle" title="Dark Mode" aria-label="Toggle dark mode">
                <i class="fas fa-moon"></i>
            </button>
            <button type="button" class="tx-btn" id="tx_refresh_report" title="Refresh">
                <i class="fas fa-sync-alt"></i> Refresh
            </button>
            <button type="button" class="tx-btn tx-btn-primary" id="tx_print_page" aria-label="Print">
                <i class="fas fa-print"></i> @lang('messages.print')
            </button>
        </div>
        <div class="tx-header-actions" style="width:100%;justify-content:flex-start;margin-top:4px;">
            <div class="tx-btn" style="cursor:default;"><span>Location</span>&nbsp;<strong id="tx_meta_location">—</strong></div>
            <div class="tx-btn" style="cursor:default;"><span>Contact</span>&nbsp;<strong id="tx_meta_contact">—</strong></div>
            <div class="tx-btn" style="cursor:default;"><span>Period</span>&nbsp;<strong id="tx_meta_range">—</strong></div>
        </div>
    </div>

    {{-- KPI cards (mirror existing values — no recalculation) --}}
    <div class="tx-kpi-grid no-print" aria-label="Tax KPIs">
        <div class="tx-kpi tone-violet">
            <div class="tx-kpi-icon"><i class="fas fa-balance-scale"></i></div>
            <span class="tx-kpi-label">Net Tax (Output − Input)</span>
            <span class="tx-kpi-value" id="tx_kpi_diff">—</span>
            <span class="tx-kpi-hint">From .tax_diff</span>
        </div>
        <div class="tx-kpi tone-teal">
            <div class="tx-kpi-icon"><i class="fas fa-arrow-circle-down"></i></div>
            <span class="tx-kpi-label">Input Taxable Total</span>
            <span class="tx-kpi-value" id="tx_kpi_input_total">—</span>
            <span class="tx-kpi-hint">Purchase tab footer</span>
        </div>
        <div class="tx-kpi tone-green">
            <div class="tx-kpi-icon"><i class="fas fa-arrow-circle-up"></i></div>
            <span class="tx-kpi-label">Output Taxable Total</span>
            <span class="tx-kpi-value" id="tx_kpi_output_total">—</span>
            <span class="tx-kpi-hint">Sales tab footer</span>
        </div>
        <div class="tx-kpi tone-orange">
            <div class="tx-kpi-icon"><i class="fas fa-minus-circle"></i></div>
            <span class="tx-kpi-label">Expense Taxable Total</span>
            <span class="tx-kpi-value" id="tx_kpi_expense_total">—</span>
            <span class="tx-kpi-hint">Expense tab footer</span>
        </div>
        <div class="tx-kpi tone-blue">
            <div class="tx-kpi-icon"><i class="fas fa-percentage"></i></div>
            <span class="tx-kpi-label">Effective Tax Rate</span>
            <span class="tx-kpi-value">—</span>
            <span class="tx-kpi-hint">UI placeholder</span>
        </div>
        <div class="tx-kpi tone-slate">
            <div class="tx-kpi-icon"><i class="fas fa-file-invoice"></i></div>
            <span class="tx-kpi-label">VAT / GST Return</span>
            <span class="tx-kpi-value">—</span>
            <span class="tx-kpi-hint">UI placeholder</span>
        </div>
        <div class="tx-kpi tone-red">
            <div class="tx-kpi-icon"><i class="fas fa-university"></i></div>
            <span class="tx-kpi-label">Filing Status</span>
            <span class="tx-kpi-value">—</span>
            <span class="tx-kpi-hint">UI placeholder</span>
        </div>
        <div class="tx-kpi tone-blue">
            <div class="tx-kpi-icon"><i class="fas fa-chart-line"></i></div>
            <span class="tx-kpi-label">Tax Growth</span>
            <span class="tx-kpi-value">—</span>
            <span class="tx-kpi-hint">UI placeholder</span>
        </div>
    </div>

    <div class="tx-future-strip no-print" aria-label="Coming soon">
        <span class="tx-chip"><i class="fas fa-file-alt"></i> VAT / GST Return</span>
        <span class="tx-chip"><i class="fas fa-cloud-upload-alt"></i> Digital Tax Filing</span>
        <span class="tx-chip"><i class="fas fa-robot"></i> AI Tax Analysis</span>
        <span class="tx-chip"><i class="fas fa-plug"></i> Power BI / Tableau</span>
        <span class="tx-chip"><i class="fas fa-history"></i> Audit Trail</span>
        <span class="tx-chip muted">UI placeholders — tax calculations unchanged</span>
    </div>

    {{-- Filters — IDs preserved for report.js + inline DataTables --}}
    <div class="tx-card no-print">
        <div class="tx-card-head">
            <div>
                <h3>@lang('report.filters')</h3>
                <p>Location · contact · date range drive existing tax AJAX &amp; tables</p>
            </div>
            <button type="button" class="tx-btn tx-btn-primary" id="tx_generate_report">
    ...
    <div class="tx-export-bar no-print">
        <button class="tx-btn tx-btn-primary" aria-label="Print"
...
@stop
@section('javascript')
<script src="{{ asset('js/tax-report-premium-ui.js?v=' . $asset_v) }}"></script>
