    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content premium-payment-modal">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fas fa-wallet"></i> @lang('lang_v1.payment')</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        {{-- Cash quick amounts — fills existing .payment-amount; no payment logic changes --}}
                        <div class="pos-cash-quick" id="pos_cash_quick_amounts" aria-label="Cash quick amounts">
                            <button type="button" data-cash-quick="500">Rs.500</button>
                            <button type="button" data-cash-quick="1000">Rs.1000</button>
                            <button type="button" data-cash-quick="2000">Rs.2000</button>
                            <button type="button" data-cash-quick="5000">Rs.5000</button>
                            <button type="button" data-cash-quick="10000">Rs.10000</button>
