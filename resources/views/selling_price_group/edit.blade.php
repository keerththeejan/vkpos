<div class="modal-dialog spg-modal-dialog" role="document">
  <div class="modal-content spg-modal-content">
    ...
    <div class="modal-header spg-modal-header">
      ...
      <h4 class="modal-title"><i class="fas fa-pen"></i> @lang( 'lang_v1.edit_selling_price_group' )</h4>
      <p class="spg-modal-sub">Update the price group name or description.</p>
    </div>
    ...
    <div class="modal-body spg-modal-body">
      ...
      <div class="spg-modal-hint">
        ...
        Product-level group prices are managed on each product or via <a href="{{ url('/update-product-price') }}" target="_blank">Update Product Price</a>.
      </div>
    </div>
