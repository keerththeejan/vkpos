<div class="modal-dialog tax-modal-dialog" role="document">
  <div class="modal-content tax-modal-content">
    ...
    <div class="modal-header tax-modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><i class="fas fa-plus-circle"></i> @lang( 'messages.add' )</h4>
      <p class="tax-modal-sub">Create a category or subcategory for organizing products.</p>
    </div>
