<div class="modal-dialog um-modal-dialog" role="document">
  <div class="modal-content um-modal-content">
    ...
    <div class="modal-header um-modal-header">
      ...
      <h4 class="modal-title"><i class="fas fa-plus-circle"></i> @lang( 'unit.add_unit' )</h4>
      <p class="um-modal-sub">Define a unit of measure for products, purchases, and sales.</p>
    </div>
