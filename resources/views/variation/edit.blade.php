  ...
  <div class="modal-content vt-modal-content">
    ...
    <div class="modal-header vt-modal-header">
      ...
      <h4 class="modal-title">
        <i class="fas fa-pen"></i> @lang('lang_v1.edit_variation')
      </h4>
      <p class="vt-modal-sub">Update the template name or manage variant values.</p>
    </div>
      ...
      <div class="vt-values-panel">
        <div class="vt-values-panel-head">
          <div>
            ...
            <span>Edit existing values or add new ones</span>
          </div>
