...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // Purchase / POS IMEI serial helpers (additive)
    Route::post('/product-serial-numbers/check', [\App\Http\Controllers\ProductSerialNumberController::class, 'check']);
    Route::get('/product-serial-numbers/available', [\App\Http\Controllers\ProductSerialNumberController::class, 'available']);
    Route::get('/product-serial-numbers/purchase/{purchase_id}', [\App\Http\Controllers\ProductSerialNumberController::class, 'forPurchase']);
    ...
    //Invoice layouts..
    Route::post('invoice-layouts/{id}/preview', [InvoiceLayoutController::class, 'preview']);
